...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "develop"
  WORKING_DIRECTORY "/Users/smitty/GitHub/RP2040-FreeRTOS/tools/picotool-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/smitty/GitHub/RP2040-FreeRTOS/tools/picotool-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/smitty/GitHub/RP2040-FreeRTOS/tools/picotool-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
